...
export const ALL_ATLASES_LIST: Map<string, string> = new Map([
    ['_loading-atlas', 'assets/_art-optimized/art-loading/_loading-atlas.json?edda844573884550f9a7bd3cd390f200'],
    ['_main-atlas', 'assets/_art-optimized/art-main/_main-atlas.json?6aad9562b8719a68f4937bcc293fcfc9']
]);
...
export const IMAGE_LIST_BY_SCENE: Map<string, Map<string, string>> = new Map([
    ...
    ['main', new Map([
        ['background', 'assets/art-main/background.png?5692611087a9c7dd75a8df842a77830e'],
        ['symbol-2', 'assets/art-main/symbol-2.png?f799e40d4b26d46c509fab10fbb7a284']
    ])]
]);
